...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://formspree.io/f/xgozggej', {
        method: 'POST',
        headers: {
      ...
      setStatus("Failed to send message. Please contact me directly at kumaripriyee73@gmail.com");
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">kumaripriyee73@gmail.com</p>
                  </div>
                </div>
